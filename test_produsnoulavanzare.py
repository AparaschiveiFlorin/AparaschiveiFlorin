...
class TestProdusnoulavanzare():
  ...
  def test_produsnoulavanzare(self):
    # Test name: produsnoulavanzare
    ...
    # 10 | click | css=.featured-products:nth-child(5) .js-product:nth-child(1) img | 
    self.driver.find_element(By.CSS_SELECTOR, ".featured-products:nth-child(5) .js-product:nth-child(1) img").click()
    # 11 | click | css=.js-product-flags > .new | 
    self.driver.find_element(By.CSS_SELECTOR, ".js-product-flags > .new").click()
    # 12 | click | css=.js-product-flags > .on-sale | 
    self.driver.find_element(By.CSS_SELECTOR, ".js-product-flags > .on-sale").click()
    # 13 | click | css=.add-to-cart | 
    self.driver.find_element(By.CSS_SELECTOR, ".add-to-cart").click()
    # 14 | click | css=.btn > .rtl-no-flip | 
