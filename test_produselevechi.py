...
class TestProduselevechi():
  ...
  def test_produselevechi(self):
    # Test name: produselevechi
    ...
    # 11 | click | linkText=Date added, oldest to newest | 
    self.driver.find_element(By.LINK_TEXT, "Date added, oldest to newest").click()
    ...
    # 27 | click | css=#payment-option-3-container > label > span | 
    self.driver.find_element(By.CSS_SELECTOR, "#payment-option-3-container > label > span").click()
    # 28 | click | css=.condition-label | 
    self.driver.find_element(By.CSS_SELECTOR, ".condition-label").click()
