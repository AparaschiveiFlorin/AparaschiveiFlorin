...
class TestCelmaipopular():
  ...
  def test_celmaipopular(self):
    # Test name: celmaipopular
    ...
    # 9 | click | css=.featured-products:nth-child(2) > .h2 | 
    self.driver.find_element(By.CSS_SELECTOR, ".featured-products:nth-child(2) > .h2").click()
    # 10 | click | css=.featured-products:nth-child(2) .js-product:nth-child(1) img | 
    ...
    # 16 | type | id=field-address1 | asdf
    self.driver.find_element(By.ID, "field-address1").send_keys("asdf")
