...
class TestNameAtoZ():
  ...
  def test_nameAtoZ(self):
    ...
    # 11 | click | linkText=Name, A to Z | 
    self.driver.find_element(By.LINK_TEXT, "Name, A to Z").click()
    ...
    # 25 | click | css=.form-group:nth-child(11) | 
    self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(11)").click()
