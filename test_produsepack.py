...
class TestProdusepack():
  ...
  def test_produsepack(self):
    # Test name: produsepack
    ...
    # 8 | click | css=#category-6 > .dropdown-item | 
    self.driver.find_element(By.CSS_SELECTOR, "#category-6 > .dropdown-item").click()
    # 9 | click | css=.js-product:nth-child(8) img | 
    self.driver.find_element(By.CSS_SELECTOR, ".js-product:nth-child(8) img").click()
    # 10 | click | css=.js-product-flags > .product-flag | 
    self.driver.find_element(By.CSS_SELECTOR, ".js-product-flags > .product-flag").click()
