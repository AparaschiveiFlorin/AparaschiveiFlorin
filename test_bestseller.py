...
class TestBestseller():
  ...
  def test_bestseller(self):
    ...
    # 9 | click | css=.featured-products:nth-child(6) > .h2 | 
    self.driver.find_element(By.CSS_SELECTOR, ".featured-products:nth-child(6) > .h2").click()
    # 10 | click | css=.featured-products:nth-child(6) .js-product:nth-child(1) img | 
    self.driver.find_element(By.CSS_SELECTOR, ".featured-products:nth-child(6) .js-product:nth-child(1) img").click()
